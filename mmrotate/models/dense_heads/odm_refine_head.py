    ...
    def get_bboxes(self,
        ...
        Returns:
            list[tuple[Tensor, Tensor]]: Each item in result_list is 2-tuple.
                ...
                (n,) tensor where each item is the predicted class index of the
                corresponding box.
        """
        ...
        for img_id, _ in enumerate(img_metas):
            ...
            proposals = self._get_bboxes_single(cls_score_list, bbox_pred_list, rois[img_id], img_shape, scale_factor, cfg, rescale)
